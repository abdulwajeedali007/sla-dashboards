  ...
  return (
    <>
      <div className="flex justify-start gap-4 items-center mb-4 px-4  ">
        ...
        <div
          className={`group flex items-center w-full gap-3 mb-2  md:mb-0 border  px-3 py-1 rounded-full`}
        >
        ...
        <div
          className={`group flex items-center gap-3 w-full border  px-3 py-1.5 rounded-full`}
        >
          <div className="h-10 w-10 border border-gray-400 rounded-full p-1">
        ...
        {/* <div className="md:flex md:gap-4"> */}
        <div
          className={`group flex items-center gap-3 mb-2 w-full   border  px-3 py-1 rounded-full `}
        >
          <div className="h-10 w-10 border border-gray-400 rounded-full p-1">
